...
@keyframes leelaanimate{
   ...
   <body>
     <div class="container text-center" >
     	<br><br>
    	<h1 class="text-center text-uppercase animateuse" >Tushar's Quiz World</h1>
    	<br><br><br><br>
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
        	...
        	<td>
            <?php
            echo "Out of 4, You have attempt ".$checked_count." option."; ?>
            </td>
            ...
            $finalresult = " insert into user(username,totalques,answerscorrect) values ('$name','4','$Resultans') ";
